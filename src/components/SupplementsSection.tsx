  ...
  return (
    <section id="supplements" className="section-padding bg-accent/30" ref={ref}>
      <div className="container mx-auto">
        ...
        >
          <h2 className="section-title">{t.supplementsTitle}</h2>
          <p className="section-subtitle">{t.supplementsSubtitle}</p>
        </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            {items.map((item, i) => (
              ...
              >
                ...
                >
                  <item.icon
                    className={item.highlight ? "text-secondary" : "text-primary"}
                    size={20}
                  />
                </div>
